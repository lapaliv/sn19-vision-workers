...
class TextToImageBase(BaseModel):
    ...
    height: int = Field(..., description="Height of the output image in pixels", gt=511, lt=2048)
    width: int = Field(..., description="Width of the output image in pixels", gt=511, lt=2048)
